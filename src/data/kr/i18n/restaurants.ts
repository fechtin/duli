...
const zh: Record<string, RestaurantTranslation> = {
  "kr-tosokchon": {
    name: "土俗村参鸡汤",
    address: "首尔钟路区紫霞门路5街5号（景福宫附近）",
    reasons: ["1980年代营业至今，首尔最知名的参鸡汤店", "就在景福宫旁，适合接在上午游览之后", "队伍虽长但翻桌快，通常等15至30分钟"],
  },
  "kr-sindang-tteokbokki-town": {
    name: "新堂洞辣炒年糕街",
    address: "首尔中区新堂洞",
    reasons: ["1950年代辣椒酱炒年糕诞生的地方", "一整条街做同一道菜，方便比较口味", "在桌边现煮，可加面条与鱼板"],
  },
  "kr-gonghwachun": {
    name: "共和春（中华街）",
    address: "仁川中区中华街路43号",
    reasons: ["就站在十九世纪末炸酱面诞生的位置", "隔壁就是炸酱面博物馆，可一并参观", "距仁川站步行数分钟，适合自首尔一日游"],
  },
  "kr-chuncheon-myeongdong-dakgalbi": {
    name: "春川明洞辣炒鸡排街",
    address: "江原道春川市明洞街",
    reasons: ["一整条街都是鸡排，1960年代这道菜在此成名", "在桌边现炒，最后用剩酱炒饭收尾", "自首尔搭ITX一小时多可达"],
  },
  "kr-sungsimdang": {
    name: "圣心堂（本店）",
    address: "大田中区大宗路480号街15",
    reasons: ["1956年开业，让大田成为「面包之城」的店", "炸红豆酥粒面包与奶油夹心面包最值得尝", "距大田站十分钟，最适合KTX中途停留"],
  },
  "kr-gogung-jeonju": {
    name: "古宫（全州韩屋村）",
    address: "全罗北道全州市完山区全州客舍3街63号",
    reasons: ["黄铜碗、牛骨高汤炊饭的正统全州拌饭", "位在韩屋村内，步行即可逛遍周边", "备有素食与不辣的版本"],
  },
  "kr-ssangdungi-dwaeji-gukbap": {
    name: "西面猪肉汤饭街",
    address: "釜山釜山镇区西面",
    reasons: ["釜山老字号猪肉汤饭最密集的一区", "许多店24小时营业，是在地经典解酒餐", "每桌备有虾酱与韭菜，自行调味"],
  },
  "kr-samjin-eomuk": {
    name: "三进鱼糕（影岛）",
    address: "釜山影岛区太宗路99号街36",
    reasons: ["1953年创立，韩国历史最久的鱼糕品牌", "设有小型博物馆与手作体验课", "可现场趁热吃，也方便外带"],
  },
  "kr-andong-jjimdak-alley": {
    name: "安东旧市场炖鸡街",
    address: "庆尚北道安东市安东旧市场",
    reasons: ["炖鸡的发源地，旧市场里整排店家", "一锅足够三人享用，适合团体", "可与河回村、陶山书院安排在同一天"],
  },
  "kr-jeju-black-pork-street": {
    name: "济州黑猪肉街（健入洞）",
    address: "济州市健入洞",
    reasons: ["专卖在地黑猪、厚切炭烤的一整条街", "沾鳀鱼酱吃，正是济州的吃法", "邻近港口与机场，适合上岛第一晚"],
  },
  "kr-tongyeong-jungang-market": {
    name: "统营中央市场",
    address: "庆尚南道统营市统营海岸路12号",
    reasons: ["来自统营湾的牡蛎，韩国最大的牡蛎养殖区", "在摊位买新鲜的，旁边料理摊即可代客烹调", "就在东皮廊壁画村下方"],
  },
  "kr-anjirang-gopchang": {
    name: "安吉朗烤肠街",
    address: "大邱南区安吉朗洞",
    reasons: ["一条街超过50家店，一路烤到天亮", "同样品质比首尔便宜许多", "最具大邱风味的宵夜街"],
  },
};
