...
export const hoiAnAroundDestinations: Destination[] = [
  {
    ...
    gallery: [
      { seed: "tra-que-vegetable-village-1", caption: "Luống rau thơm buổi sáng ở Trà Quế", ratio: "16/9" },
      { seed: "tra-que-vegetable-village-2", caption: "Gánh nước tưới rau bằng đôi thùng", ratio: "4/3" },
    ],
  ...
  },
  {
    ...
    gallery: [
      { seed: "kim-bong-carpentry-village-1", caption: "Thợ chạm gỗ trong xưởng Kim Bồng", ratio: "16/9" },
      { seed: "kim-bong-carpentry-village-2", caption: "Đò ngang sang cù lao Cẩm Kim", ratio: "4/3" },
    ],
  ...
  },
  {
    ...
    gallery: [
      { seed: "bay-mau-coconut-forest-1", caption: "Thuyền thúng luồn giữa rừng dừa nước", ratio: "16/9" },
      { seed: "bay-mau-coconut-forest-2", caption: "Lá dừa nước cao quá đầu người", ratio: "4/3" },
    ],
  ...
  },
  {
    ...
    gallery: [
      { seed: "cua-dai-beach-1", caption: "Cửa sông Thu Bồn đổ ra biển", ratio: "16/9" },
      { seed: "cua-dai-beach-2", caption: "Kè đá chống xói lở dọc bờ Cửa Đại", ratio: "4/3" },
    ],
